...
enum PUMP_LOW_LEVEL_E {
	PUMP_FAIL_LOW_LEVEL_EVENT_IDLE = 0,
	PUMP_FAIL_LOW_LEVEL_EVENT_0TO1_DAY,
	PUMP_FAIL_LOW_LEVEL_EVENT_1TO4_DAY,
	PUMP_FAIL_LOW_LEVEL_EVENT_4TO7_DAY,
	PUMP_FAIL_LOW_LEVEL_EVENT_7MORE_DAY,
};
