...
enum PUMP_LOW_LEVEL_STAGE_E {
	PUMP_LOW_LEVEL_STAGE_IDLE = 0,
	PUMP_LOW_LEVEL_STAGE_DAY1,
	PUMP_LOW_LEVEL_STAGE_DAY2,
	PUMP_LOW_LEVEL_STAGE_DAY3,
	PUMP_LOW_LEVEL_STAGE_DAY4,
	PUMP_LOW_LEVEL_STAGE_DAY5,
	PUMP_LOW_LEVEL_STAGE_DAY6,
	PUMP_LOW_LEVEL_STAGE_DAY7
};
